...
page = st.sidebar.radio("Select Functionality", ["Home", "Finance Chatbot","Finance Document oriented Q & A","Stock Market Analysis & Risk Prediction", "News Sentiment Analysis & Price Prediction"])
...
elif page == "Finance Document oriented Q & A":
